 ...
 alert('coming to');
  if (pin){
    return L.divIcon({
      ...
      '<i class="fa flaticon-' + iconName + ' fa-stack-1x" style="color:' + iconColor + ';padding-left:0px;padding-top:20px;" ></i>' +
      '<i class="fa flaticon-location-pointer fa-stack-2x" style= "padding-left:0px;padding-top:0px;" ></i>' +
      '</span>',
    ...
    return L.divIcon({
      ...
      html:
      '<span class="">' +
      '<i class="flaticon-' + iconName + '" style="color:' + iconColor + ';padding-left:0px;padding-top:0px;" ></i>' +
      // '<i class="fa fa-' + iconName + ' fa-stack-1x" style="color:' + iconColor + ';padding-left:0px;padding-top:0px;" ></i>' +
